...
<style>
  /* Sidebar Brand Container - Tight & Professional */
  .main-sidebar .sidebar-brand {
    height: 95px !important; /* Nilakihan para sa vertical logo */
    line-height: 95px !important;
    display: flex !important;
    align-items: center;
    justify-content: center;
    padding: 0 !important; /* Tinanggal ang padding para walang white border */
    margin-bottom: 10px;
    overflow: hidden;
  ...
  .main-sidebar .sidebar-brand img.navbar-logos {
    height: 100% !important; /* Sinagad sa container */
    width: 100% !important; /* Sinagad sa container */
    object-fit: contain !important; /* Para hindi ma-stretch pero sagad */
    padding: 5px; /* Konting hinga lang para hindi dikit sa line */
  }

  /* Para sa Mini Sidebar (Collapsed) */
  ...
  body.sidebar-mini .main-sidebar .sidebar-brand-sm img.navbar-logos {
...
<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    ...
    <div class="sidebar-brand">
      <a href="<?=base_url()?>">
        <img class="navbar-logos" alt="Logo" src="<?=base_url('assets/uploads/logos/logo-half.png')?>?v=<?=time()?>">
      </a>
    </div>
