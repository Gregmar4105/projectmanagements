...
<style>
  .login-brand {
    margin-bottom: 20px !important; /* Sakto lang na distansya sa card */
    margin-top: 15px !important;
    display: flex;
    justify-content: center;
  }
  .login-brand img {
    width: 140px !important; /* Professional balanced size */
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="login-brand">
              <img src="<?=base_url('assets/uploads/logos/'.full_logo());?>?v=2" alt="logo">
            </div>
