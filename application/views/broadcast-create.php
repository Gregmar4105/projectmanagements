                      ...
                      <form action="<?=base_url('broadcast/create')?>" method="POST" id="broadcast-form">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control select2" name="to_user[]" multiple="">
                            ...
                            <option value="admins"><?=$this->lang->line('all')?htmlspecialchars($this->lang->line('all')):'All'?> <?=$this->lang->line('admin')?htmlspecialchars($this->lang->line('admin')):'Admin'?></option>

                            <option value="team_members"><?=$this->lang->line('team_members')?htmlspecialchars($this->lang->line('team_members')):'Team Members'?></option>

                            <option value="clients"><?=$this->lang->line('clients')?htmlspecialchars($this->lang->line('clients')):'Clients'?></option>
